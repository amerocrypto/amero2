...
public:
    ...
    // Amero Specific WalletInitInterface InitCoinJoinSettings
 ...
 * between amerox, and amero-qt and non-server tools.
*/
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-sporkaddr=<ameroaddress>", "Override spork address. Only useful for regtest and devnet. Using this on mainnet or testnet will ban you.", false, OptionsCategory::DEBUG_TEST);
    ...
    gArgs.AddArg("-platform-user=<user>", "Set the username for the \"platform user\", a restricted user intended to be used by Amero Platform, to the specified username.", false, OptionsCategory::MASTERNODE);
...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(_("Public Resource ℗"), 2020, COPYRIGHT_YEAR) + "\n" +
           ...
           strprintf(_("Public Resource ℗ 2020 Amero Developers/PRL>") + "\n" +
           "\n" +
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if Amero Core is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if Amero Core is started while in a temporary directory.\n",
        ...
        do {
            ...
            try {
                ...
                if (!fDisableGovernance && !fTxIndex
                   && chainparams.NetworkIDString() != CBaseChainParams::REGTEST) { // TODO remove this when pruning is fixed. See https://github.com/amerocrypto/amero/pull/1817 and https://github.com/amerocrypto/amero/pull/1743
    ...
    // ********************************************************* Step 10c: schedule Amero-specific tasks
