...
official/supported Docker Images found at https://hub.docker.com/r/amerocrypto/amerox/
...
**NOTE: Please update the image description at https://hub.docker.com/r/amerocrypto/amerox-develop/ when changing the above text**