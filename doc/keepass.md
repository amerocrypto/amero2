...
The following new options are available for amerox and amero-qt:
...
The following rpc commands are available:
 ...
 - _keepass init_: sets up the association between amerox and keepass by generating an AES key and sending an association message to KeePassHttp. This will trigger KeePass to ask for an Id for the association. Returns the association and the base64 encoded string for the AES key.
...
Extended guide with screenshots is also available: https://www.amerocrypto.com/forum/threads/keepass-integration.3620/
