...
* amero.conf: contains configuration settings for amerox or amero-qt
* amerox.pid: stores the process id of amerox while running
...
* debug.log: contains debug information and general logging generated by amerox or amero-qt
