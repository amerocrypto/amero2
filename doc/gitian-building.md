...
git clone https://github.com/amerocrypto/amero
...
```bash
    ...
    From https://github.com/amerocrypto/amero
...
[amero/gitian.sigs](https://github.com/amerocrypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
